...
public final class PlayerProperty {
    ...
    private PlayerProperty(String id, Component displayName,
                           ToIntFunction<Player> intValue, int maxValue) {
        this.id = id;
    ...
    public boolean isActive(Player player) {
        return intValue.applyAsInt(player) > 0;
    }
    ...
    public static final class Builder {
        ...
        public PlayerProperty build() {
            ...
            return new PlayerProperty(id, displayName, intValue, maxValue);
        }
    }
}
