...
public class BladeLoader {
    ...
    public BladeLoader() {
        ...
        if(autu){
            ...
            ITEM_AW=new Item_AwNamed(Item.ToolMaterial.DIAMOND,1.0F,"awnamed").setMaxDamage(Integer.MAX_VALUE-32768).setCreativeTab(Main.TABKABLADE_BLADES).setNoRepair();
        }
