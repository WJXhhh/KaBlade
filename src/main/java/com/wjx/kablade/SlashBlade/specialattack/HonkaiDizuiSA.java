...
public class HonkaiDizuiSA extends SpecialAttackBase {
    ...
    public void doSpacialAttack(ItemStack itemStack, EntityPlayer entityPlayer) {
            ...
            if(!world.isRemote)
        {
            for(int i =0;i<3;i++)
            {
                float extraDamage = MathFunc.amplifierCalc((ItemSlashBlade.BaseAttackModifier.get((itemStack.getTagCompound()))),25f);
            ...
            float extraDamage = MathFunc.amplifierCalc((ItemSlashBlade.BaseAttackModifier.get((itemStack.getTagCompound()))),20f);
