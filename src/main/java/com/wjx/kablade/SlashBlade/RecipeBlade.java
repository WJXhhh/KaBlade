...
public class RecipeBlade extends ShapedOreRecipe {
    ...
    public RecipeBlade(ResourceLocation group, ItemStack result,ItemStack inheritBlade, Object... recipe) {
     ...
     * @param recipe 合成
     */
    public RecipeBlade(ResourceLocation group, ItemStack result,ItemStack inheritBlade, List<ItemStack> materialBlade, Object... recipe) {
