...
public class RockyEX {
    ...
    public void init(LoadEvent.InitEvent event) {
        ...
        IRecipe recipe = new RecipeAwakeBlade(new ResourceLocation(bladestr,"rocky_ex"),
                ...
                new Object[]{
                        ...
                        'B', prevblade,
                        'C', SlashBlade.findItemStack(bladestr, "wjx.blade.rocky_huagang", 1),
                        'D', SlashBlade.findItemStack(bladestr, "wjx.blade.rocky_shanchang", 1),
                });
