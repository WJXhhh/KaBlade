...
public class RockyShanchang {
    String name = "wjx.blade.rocky_shanchang";
    String key = "wjx.blade.rocky_shanchang";

    public RockyShanchang(){
    ...
    public void init(LoadEvent.InitEvent event) {
        ...
        IRecipe recipe = new SlashBladeRecipeModding(new ResourceLocation(bladestr,"rocky_shanchang"),
                ...
                new Object[]{
                        ...
                        "A  ",
                        'A', prevblade,
                        'B', new ItemStack(Item.getItemFromBlock(Blocks.STONE),1,3),
                });

        SlashBlade.addRecipe("rocky_shanchang", recipe);
    }
