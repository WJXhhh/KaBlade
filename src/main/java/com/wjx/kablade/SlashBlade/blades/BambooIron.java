...
public class BambooIron {
    String name = "wjx.blade.bamboo_iron";
    String key = "wjx.blade.bamboo_iron";
    ...
    public void init(LoadEvent.InitEvent event) {
        ...
        IRecipe recipe = new RecipeAwakeBlade(new ResourceLocation(bladestr,"bamboo_iron"),
                ...
                new Object[]{
                        ...
                        " B ",
                        "A  ",
                        'A', new ItemStack(SlashBlade.bladeBambooLight),
                        'B', new ItemStack(Items.IRON_INGOT),
                });

        SlashBlade.addRecipe("bamboo_iron", recipe);
    }
