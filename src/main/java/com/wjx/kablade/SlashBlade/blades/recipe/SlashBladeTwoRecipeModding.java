...
public class SlashBladeTwoRecipeModding extends ShapedOreRecipe {
    ItemStack requiredStateBlade;
    ItemStack requiredStateBlade2;

    public SlashBladeTwoRecipeModding(ResourceLocation loc, ItemStack result, ItemStack requiredStateBlade,ItemStack requiredStateBlade2, Object... recipe) {
    ...
    public boolean matches(InventoryCrafting inv, World world) {
        ...
        if(!result || requiredStateBlade.isEmpty() || requiredStateBlade2.isEmpty()){
            return false;
        }
        ...
        for(int idx = 0; idx < inv.getSizeInventory(); idx++){
            ...
            // super.matches 只校验物品类型，这里拒绝名称不符或重复的刀。
            return false;
        }
