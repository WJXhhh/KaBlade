...
public class SL_Young1 {
    public static String name = "wjx.splight.young1";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        IRecipe recipe = new SlashBladeRecipeModding(new ResourceLocation(bladestr,"sp_young1"),targetBlade, initialBlade,
                new Object[]{
                        "QSQ",
                        "SKS",
                        "ISI",
        ...
        SlashBlade.addRecipe("sp_young1", recipe);
    }
