...
public class SL_Senta {
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemStack initialBlade = SlashBlade.findItemStack(bladestr,SL_Young2.name,1);
        ...
        if (Loader.isModLoaded("slashblade_addon")){
            ItemSlashBlade.SpecialAttackType.set(sp2.getTagCompound(),36);
        }
        else{
            ItemSlashBlade.SpecialAttackType.set(sp2.getTagCompound(),6);
        }

        IRecipe recipe = new SPLightRecipe(new ResourceLocation(bladestr,"sp_senta"),targetBlade, initialBlade,sp1,sp2,
                new Object[]{
                        "DWD",
                        "ZBZ",
                        "GXG",
        ...
        SlashBlade.addRecipe("sp_senta", recipe);
    }
