...
public class EntityThunderEdgeAttack extends Entity implements IThrowableEntity {
    ...
    public EntityThunderEdgeAttack(World world){
        super(world);
        ticksExisted = 0;
        timer = new Timer();
    ...
    public EntityThunderEdgeAttack(World world, EntityLivingBase ownerIn){
        this(world);
        owner = ownerIn;
