...
public class EntitySummonHedra extends Entity implements IThrowableEntity {
    ...
    public EntitySummonHedra(World par1World) {
        super(par1World);
    ...
    public EntitySummonHedra(World par1World, EntityLivingBase entityLiving, float AttackLevel, double xIn, double yIn , double zIn, float pitchIn, float yawIn) {
        this(par1World);
    ...
    static {
        THROWER_ENTITY_ID = EntityDataManager.createKey(EntitySummonHedra.class, DataSerializers.VARINT);
        LIFETIME = EntityDataManager.createKey(EntitySummonHedra.class, DataSerializers.VARINT);
        ROLL = EntityDataManager.createKey(EntitySummonHedra.class, DataSerializers.FLOAT);
        TARGET_ENTITY_ID = EntityDataManager.createKey(EntitySummonHedra.class, DataSerializers.VARINT);
        INTERVAL = EntityDataManager.createKey(EntitySummonHedra.class, DataSerializers.VARINT);
        COLOR = EntityDataManager.createKey(EntitySummonHedra.class, DataSerializers.VARINT);
        LOCK_YAW = EntityDataManager.createKey(EntitySummonHedra.class,DataSerializers.FLOAT);
        LIGHTING = EntityDataManager.createKey(EntitySummonHedra.class,DataSerializers.BOOLEAN);
    }
}
