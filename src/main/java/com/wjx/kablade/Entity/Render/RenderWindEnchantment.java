...
public class RenderWindEnchantment extends Render<EntityWindEnchantment> {
    ...
    public void doRender2(EntityWindEnchantment entity, double x, double y, double z, float entityYaw, float partialTicks) {
        int renderTick = entity.getDataManager().get(EntityWindEnchantment.renderTick);
        GlStateManager.disableLighting();
        GlStateManager.enableBlend();
        float lastx = OpenGlHelper.lastBrightnessX;
        ...
        GlStateManager.color(1f,1f,1f);
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE);
        Minecraft.getMinecraft().getTextureManager().bindTexture(effect1);
        GlStateManager.rotate(-180,1,0,0);
        bufferBuilder.pos(-10,0,-10).tex(0,0).endVertex();
        bufferBuilder.pos(10,0,-10).tex(1,0).endVertex();
        bufferBuilder.pos(10,0,10).tex(1,1).endVertex();
        ...
        GlStateManager.color(1f,1f,1f);
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE);
        Minecraft.getMinecraft().getTextureManager().bindTexture(effect2);
        GlStateManager.rotate(-180,1,0,0);
        bufferBuilder.pos(-10,0,-10).tex(0,0).endVertex();
        bufferBuilder.pos(10,0,-10).tex(1,0).endVertex();
        bufferBuilder.pos(10,0,10).tex(1,1).endVertex();
        ...
        GlStateManager.color(1f,1f,1f);
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE);
        Minecraft.getMinecraft().getTextureManager().bindTexture(effect3);
        GlStateManager.rotate(-180,1,0,0);
        bufferBuilder.pos(-10,0,-10).tex(0,0).endVertex();
        bufferBuilder.pos(10,0,-10).tex(1,0).endVertex();
        bufferBuilder.pos(10,0,10).tex(1,1).endVertex();
        ...
        GlStateManager.color(1f,1f,1f);
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE);
        Minecraft.getMinecraft().getTextureManager().bindTexture(effect4);
        GlStateManager.rotate(-180,1,0,0);
        bufferBuilder.pos(-10,0,-10).tex(0,0).endVertex();
        bufferBuilder.pos(10,0,-10).tex(1,0).endVertex();
        bufferBuilder.pos(10,0,10).tex(1,1).endVertex();
