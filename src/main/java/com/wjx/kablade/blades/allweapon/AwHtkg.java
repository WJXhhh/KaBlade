 ...
 */
public class AwHtkg extends BladeDefineBase {
    public AwHtkg(BootstapContext<SlashBladeDefinition> context) {
        String key = getKey();
        context.register(createBladeKey(key), new SlashBladeDefinition(
                ...
                List.of(
                        new EnchantmentDefinition(
                                ResourceLocation.fromNamespaceAndPath("minecraft", "bane_of_arthropods"), 20)
                )
        ));
    }
