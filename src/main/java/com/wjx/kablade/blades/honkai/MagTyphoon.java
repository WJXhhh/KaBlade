...
/** MAG-Typhoon, upgraded from Mag Storm. */
public class MagTyphoon extends BladeDefineBase {
    public MagTyphoon(BootstapContext<SlashBladeDefinition> context) {
        String key = getKey();
        context.register(createBladeKey(key), new SlashBladeDefinition(
                getBaseBladeId(BaseBladeType.HONKAI),
                ResourceUtil.getLocation(key),
                RenderDefinition.Builder.newInstance()
                        .modelName(ResourceUtil.getLocation("model/honkai/mag_typhoon/mdl.obj"))
                        .textureName(ResourceUtil.getLocation("model/honkai/mag_typhoon/tex.png"))
                ...
                PropertiesDefinition.Builder.newInstance()
                        ...
                        .addSpecialEffect(ModSpecialEffects.ROARING_NIMBUS.getId())
                        .build(),
                List.of(
