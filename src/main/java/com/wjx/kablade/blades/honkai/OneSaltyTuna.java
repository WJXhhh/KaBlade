...
/** One Salty Tuna, ported from 1.12.2 honkaip2. */
public class OneSaltyTuna extends BladeDefineBase {
    public OneSaltyTuna(BootstapContext<SlashBladeDefinition> context) {
        String key = getKey();
