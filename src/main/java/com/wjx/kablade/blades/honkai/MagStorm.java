    ...
    public MagStorm(BootstapContext<SlashBladeDefinition> context) {
        ...
        context.register(createBladeKey(key), new SlashBladeDefinition(
                ...
                RenderDefinition.Builder.newInstance()
                        .modelName(ResourceUtil.getLocation("model/honkai/mag_storm/mdl_mag_storm.obj"))
                        .textureName(ResourceUtil.getLocation("model/honkai/mag_storm/tex_mag_storm.png"))
