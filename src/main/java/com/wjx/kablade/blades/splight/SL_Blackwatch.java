 ...
 * 龙一文字线黑表刀：龙一「黯」。
 * <p>
 * 从 1.12.2 {@code SL_Blackwatch} 移植而来，SA「熔岩驱动」，自带特殊效果「圣光」「爆裂驱动」。
 * 属性：攻击 12.0、耐久 191、默认妖化。
 */
public class SL_Blackwatch extends BladeDefineBase {
    public SL_Blackwatch(BootstapContext<SlashBladeDefinition> context) {
        String key = getKey();
        context.register(createBladeKey(key), new SlashBladeDefinition(
                ...
                PropertiesDefinition.Builder.newInstance()
                        ...
                        .slashArtsType(ModSlashArts.LAVE_DRIVE.getId())
