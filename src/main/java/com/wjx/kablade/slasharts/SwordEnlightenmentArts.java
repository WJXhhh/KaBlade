...
/** Sword Enlightenment, Key of Limpidity's purple-white conceptual blade field. */
public final class SwordEnlightenmentArts extends SlashArts {
    ...
    public SwordEnlightenmentArts(Function<LivingEntity, ResourceLocation> state) {
        super(state);
    }
    ...
    public ResourceLocation doArts(ArtsType type, LivingEntity user) {
        ...
        SwordEnlightenmentEntity.spawn(level, user, damage, attackPosition);
