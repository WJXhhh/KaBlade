...
public class AL_YingYue {
    String name = "wjx.allweapon.yingyue";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/yingyue/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/yingyue/model");
        ItemSlashBladeNamed.IsDefaultBewitched.set(Tag, true);
        ItemSlashBlade.StandbyRenderType.set(Tag, 2);
        ItemSlashBlade.SpecialAttackType.set(Tag,411);
