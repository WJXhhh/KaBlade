...
public class AL_Shangguyujin {
    String name = "wjx.allweapon.shangguyujin";

    public AL_Shangguyujin(){
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/shangguyujin/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/shangguyujin/model");
