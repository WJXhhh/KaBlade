...
public class AL_Youming {

    String name = "wjx.allweapon.youming";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/youming/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/youming/model");
        ItemSlashBladeNamed.IsDefaultBewitched.set(Tag, true);
        ItemSlashBlade.StandbyRenderType.set(Tag, 2);
        ItemSlashBlade.SummonedSwordColor.set(Tag, 0x222222);
