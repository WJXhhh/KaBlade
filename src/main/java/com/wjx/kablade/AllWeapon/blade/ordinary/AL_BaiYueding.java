...
public class AL_BaiYueding {
    String name = "wjx.allweapon.baiyueding";

    public AL_BaiYueding(){
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/baiyueding/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/baiyueding/model");
        ItemSlashBladeNamed.IsDefaultBewitched.set(Tag, true);
        ItemSlashBlade.StandbyRenderType.set(Tag, 2);
        ItemSlashBlade.SummonedSwordColor.set(Tag, 0xeeeeee);
        ItemSlashBlade.SpecialAttackType.set(Tag,403);
        ItemSlashBlade.BaseAttackModifier.set(Tag,10f);
        customblade.addEnchantment(Enchantments.PROTECTION,6);
