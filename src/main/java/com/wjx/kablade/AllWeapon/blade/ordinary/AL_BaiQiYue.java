...
public class AL_BaiQiYue {
    String name = "wjx.allweapon.baiqiyue";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/baiqiyue/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/baiqiyue/model");
