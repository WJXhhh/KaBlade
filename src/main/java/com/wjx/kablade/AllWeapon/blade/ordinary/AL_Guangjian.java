...
public class AL_Guangjian {

    String name = "wjx.allweapon.guangjian";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/guangjian/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/guangjian/model");
        ItemSlashBladeNamed.IsDefaultBewitched.set(Tag, true);
        ItemSlashBlade.StandbyRenderType.set(Tag, 2);
        ItemSlashBlade.SummonedSwordColor.set(Tag, 0xbbbbee);
        ItemSlashBlade.SpecialAttackType.set(Tag,406);
