...
public class AL_Htkg {

    String name = "wjx.allweapon.htkg";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/htkg/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/htkg/model");
        ItemSlashBladeNamed.IsDefaultBewitched.set(Tag, true);
        ItemSlashBlade.StandbyRenderType.set(Tag, 2);
        ItemSlashBlade.SummonedSwordColor.set(Tag, 0x999f99);
        ItemSlashBlade.SpecialAttackType.set(Tag,403);
        ItemSlashBlade.BaseAttackModifier.set(Tag,8f);
        customblade.addEnchantment(Enchantments.BANE_OF_ARTHROPODS, 20);
