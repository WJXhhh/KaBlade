...
public class AL_Huami {

    String name = "wjx.allweapon.huami";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/huami/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/huami/model");
        ItemSlashBladeNamed.IsDefaultBewitched.set(Tag, true);
        ItemSlashBlade.StandbyRenderType.set(Tag, 2);
        ItemSlashBlade.SummonedSwordColor.set(Tag, 0x33bbee);
        ItemSlashBlade.SpecialAttackType.set(Tag,407);
        ItemSlashBlade.BaseAttackModifier.set(Tag,8f);

        customblade.addEnchantment(Enchantments.BLAST_PROTECTION, 20);
