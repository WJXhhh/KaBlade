...
public class AL_FengZhiYing {

    String name = "wjx.allweapon.fengzhiying";

    public AL_FengZhiYing(){
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/fengzhiying/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/fengzhiying/model");
        ItemSlashBladeNamed.IsDefaultBewitched.set(Tag, true);
        ItemSlashBlade.StandbyRenderType.set(Tag, 2);
        ItemSlashBlade.SummonedSwordColor.set(Tag, 0xbbbbee);
        ItemSlashBlade.SpecialAttackType.set(Tag,405);
        ItemSlashBlade.BaseAttackModifier.set(Tag,10f);

        customblade.addEnchantment(Enchantments.FEATHER_FALLING, 20);
