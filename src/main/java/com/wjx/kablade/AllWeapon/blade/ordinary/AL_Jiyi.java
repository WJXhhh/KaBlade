...
public class AL_Jiyi {

    String name = "wjx.allweapon.jiyi";
    ...
    public void init(LoadEvent.InitEvent event){
        ...
        ItemSlashBlade.TextureName.set(Tag, "allweapon/jiyi/texture");
        ItemSlashBlade.ModelName.set(Tag, "allweapon/jiyi/model");
        ItemSlashBladeNamed.IsDefaultBewitched.set(Tag, true);
        ItemSlashBlade.StandbyRenderType.set(Tag, 2);
        ItemSlashBlade.SummonedSwordColor.set(Tag, 0x2200ef);
