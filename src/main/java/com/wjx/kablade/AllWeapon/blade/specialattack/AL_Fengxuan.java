    ...
    public void doSpacialAttack(ItemStack itemStack, EntityPlayer entityPlayer) {
        ...
        if(!world.isRemote) {
            ...
            if (dim != null) {
                ...
                Vec3d offset = new Vec3d(entityPlayer.posX, entityPlayer.posY, entityPlayer.posZ).add(0.0, entityPlayer.getEyeHeight(), 0.0);
                Vec3d offsettedLook = offset.add(post.x * 5.0, post.y * 5.0, post.z * 5.0);
