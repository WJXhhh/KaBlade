...
public class PotionInit {
    ...
    public static final Potion PARALY = new PotionParaly().registerPotionAttributeModifier(SharedMonsterAttributes.MOVEMENT_SPEED,UUID_PARALY.toString(),-0.05d,2);
