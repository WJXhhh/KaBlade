...
public final class EntityRendererEvents {
    ...
    public static void onRegisterRenderers(final EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.DRACONIC_VORTEX_RING.get(), DraconicVortexRingRenderer::new);
        ...
        event.registerEntityRenderer(ModEntities.THUNDERBOLT_CALL.get(), ThunderboltCallRenderer::new);
        event.registerEntityRenderer(ModEntities.NARUKAMI_DIVINITY.get(), NarukamiDivinityRenderer::new);
